...
class WhiteNoise:
    ...
    def _get_whitenoise_filenames(self):
        whitenoise_metadata = pd.read_csv(os.path.join(self.basepath, 'metadata', 'WhiteNoise.csv'))
    ...
    def get_train_val_filenames(self):
        ...
        print("Noise training:", len(whitenoise_train))
        print("Noise validation:", len(whitenoise_val))
...
whitenoise_basepath = '/home/thallessilva/Documents/datasets/WhiteNoise'
...
wn = WhiteNoise(whitenoise_basepath, val_dataset_size=200)
